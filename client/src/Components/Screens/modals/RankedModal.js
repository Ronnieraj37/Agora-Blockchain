    ...
    <div>
      {status === STATUS.ACTIVE ? (
        ...
        <div
          ...
          onClick={() => {
            console.log("Election is not started yet");
          }}
        >
          VOTE
        </div>
        ...
        >
          ...
          <div style={{ margin: "10px", maxWidth: "700px", width: "96%" }}>
            ...
            <p style={{ textAlign: "center" }}>
              Move up/down the card to give preference
            </p>
          ...
          <Flex px={4} py={3} justifyContent={"flex-start"}>
            ...
            <Button ml={3} type="submit" onClick={handleVoteSubmit}>
              Confirm
            </Button>
          </Flex>
        </Card>
